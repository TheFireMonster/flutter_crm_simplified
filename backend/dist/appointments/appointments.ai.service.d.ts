...
export declare class AppointmentsAiService {
    ...
    createFromAi(dto: CreateAppointmentFromAiDto): Promise<import("./entities/appointments.entity").Appointment | import("../ai-actions/entities/ai-action.entity").AiAction | null>;
}
