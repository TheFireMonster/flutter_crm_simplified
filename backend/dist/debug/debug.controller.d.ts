...
export declare class DebugController {
    ...
    aiAction(body: {
        ...
        payload: any;
    }): Promise<import("../ai-actions/entities/ai-action.entity").AiAction | import("../customers/entities/customers.entity").Customer | import("../appointments/entities/appointments.entity").Appointment | null>;
